...
//console.log("partnerJWTToken is: " + partnerJWTToken);
    var paymentInquiry_Response = http.post(
      `${env}/biller/v1/payment-inquiry`,
      JSON.stringify(body),
      { headers: {
    ...
    var result = JSON.parse(paymentInquiry_Response.body);
    //console.log("---------------responseCode is:      " + result.responseCode);
    check(paymentInquiry_Response, {
...
export function handleSummary(data) {
  return {
    "summary_apigee_paymentInquiry.html": htmlReport(data),
  };
}